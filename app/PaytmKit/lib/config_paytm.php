...
// define('PAYTM_MERCHANT_KEY', 'a9LX0%@4CULahgw_'); //Change this constant's value with Merchant key downloaded from portal
// define('PAYTM_MERCHANT_MID', 'ZQuxYB60583337152490'); //Change this constant's value with MID (Merchant ID) received from Paytm
