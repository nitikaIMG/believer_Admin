...
<a  href="<?php echo action('CardController@view_team') ?>" class="btn btn-sm btn-light font-weight-bold text-uppercase text-primary float-right"><i class="fad fa-eye"></i>&nbsp; View All Teams</a>
@endsection('card-heading-btn')

@section('content')
<div class="card">
    <div class="card-header">Edit Team</div>
      <form class="card-body" action="<?php echo action('CardController@edit_team',base64_encode(serialize($data->id)))?>" enctype='multipart/form-data' method="post">
    	{{csrf_field()}}
        @include('alert_msg')
