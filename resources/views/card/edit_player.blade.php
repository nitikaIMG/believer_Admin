...
<a  href="<?php echo action('CardController@view_player') ?>" class="btn btn-sm  btn-sm rounded-pill btn-light font-weight-bold text-primary float-right"><i class="fad fa-eye"></i>&nbsp; View All Players</a>
...
<div class="card">
    <div class="card-header">Edit Player</div>
      <form class="card-body" action="<?php echo action('CardController@edit_player',base64_encode(serialize($player->id)))?>" enctype='multipart/form-data' method="post">
    	{{csrf_field()}}
