...
<div class="card mb-4">
    <div class="card-header">Card Profit & Loss Day Wise Report</div>
    <div class="card-body">
...
<script type="text/javascript">
    ...
    var enddate = $('#enddate').val();
        $('#allmatches_datatable').DataTable({
            ...
            "searching": false,
            "ajax":{
                     "url": '<?php echo URL::asset('my-admin/view_card_daily_report_dt'); ?>?startdate='+startdate+'&enddate='+enddate,
                     "dataType": "json",
                     "type": "POST",
