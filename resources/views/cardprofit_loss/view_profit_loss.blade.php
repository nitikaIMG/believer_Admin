...
<script type="text/javascript">
    ...
    var enddate = $('#enddate').val(); 
        ...
        $('#allmatches_datatable').DataTable({
            ...
            "ajax":{
                     "url": '<?php echo action('CardProfitLossController@view_profit_loss_dt');?>?name='+name+'&startdate='+startdate+'&enddate='+enddate+'&option='+option+'&fantasy_type='+fantasy_type,
                     "dataType": "json",
                     "type": "POST",
