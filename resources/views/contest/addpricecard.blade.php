                      ...
                      @else
                        <div class="col-md-6">
                          <div class="form-group">
                              ...
                              {{ Form::text('price_percent', null, ['value' => '', 'required' => '', 'placeholder' => 'Price Amount In Percentage ', 'min' => '1', 'autocomplete' => 'off', 'class' => 'form-control form-control-solid', 'onkeypress' => 'return isNumberKey(event)','id'=>'winnerpercent']) }}
                ...
                <table class="table table-bordered table-striped table-hover dataTable text-nowrap" id="dataTable" width="100%" cellspacing="0">
                        ...
                        if (!empty($findallpricecards)) {
                            ...
                            <tr role="row" class="odd">
                                ...
                                @if ($pricecars->price_percent != null)
                                    ...
                                    <td>{{ $pricecars->total }}rs({{$pricecars->price_percent * $pricecars->winners }}%)</td> -->
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <?php ?>
                            <td></td>
                            <td>Total-<?php echo $twin.'('.number_format((($twin/$findchallenge1->maximum_user)*100),2,'.','').'%)'; ?></td>
                            <td></td>
                            <td>Total-<?php echo $tamt.'('.number_format($tper,2,'.','').'%)'; ?></td>
                            <td></td>
                        </tr>
                        <tr>
                            <th>S No.</th>
