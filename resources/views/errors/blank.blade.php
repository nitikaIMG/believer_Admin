...
<html lang="en">
    <head>
        ...
        <title>Blank - IMG Global Infotech</title>
        <link href="css/bootstrap.css" rel="stylesheet" />
        <link rel="icon" type="image/x-icon" href="assets/img/favicon.png" />
        <script data-search-pseudo-elements defer src="js/all.min.js"></script>
        <script src="js/feather.min.js"></script>
        <link href="css/bijarniadream.css" rel="stylesheet" />
    ...
    <body class="nav-fixed">
        ...
        >
            <a class="navbar-brand d-none d-sm-block" href="index.html"
                >IMG Global Infotech</a
            ><button
                class="btn btn-sm btn-icon order-1 order-lg-0 mr-lg-2"
                id="sidebarToggle"
            ...
            >
                <svg
                    ...
                    width="25"
                    height="18"
                    viewBox="0 0 27.623 18"
                    class="injectable"
                >
                    <g transform="translate(-599 -99)">
                        <path
                            d="M624.811,134.423h-24A1.817,1.817,0,0,1,599,132.611h0a1.817,1.817,0,0,1,1.811-1.811h24a1.817,1.817,0,0,1,1.811,1.811h0A1.817,1.817,0,0,1,624.811,134.423Z"
                            transform="translate(0 -24.6)"
                            fill="#134ee6"
                        ></path>
                        <path
                            d="M618.019,166.123H600.811A1.817,1.817,0,0,1,599,164.311h0a1.817,1.817,0,0,1,1.811-1.811h17.208a1.817,1.817,0,0,1,1.811,1.811h0A1.817,1.817,0,0,1,618.019,166.123Z"
                            transform="translate(0 -49.123)"
                            fill="#134ee6"
                        ></path>
                        <path
                            d="M613.491,102.623H600.811A1.817,1.817,0,0,1,599,100.811h0A1.817,1.817,0,0,1,600.811,99h12.679a1.817,1.817,0,0,1,1.811,1.811h0A1.817,1.817,0,0,1,613.491,102.623Z"
                            fill="#134ee6"
                        ></path>
                    </g>
                </svg>
            ...
            <ul class="navbar-nav align-items-center ml-auto">
                <li class="nav-item dropdown no-caret mr-3">
                    ...
                    ></a>
                    <div
                        class="dropdown-menu dropdown-menu-right py-0 o-hidden mr-n15 mr-lg-0 animated--fade-in-up"
                    ...
                    >
                        <a
                            ...
                            target="_blank"
                            ><div
                                class="icon-stack bg-primary-soft text-primary mr-4"
                            >
                ...
                <li
                    class="nav-item dropdown no-caret mr-3 dropdown-notifications"
                >
                    <a
                        class="btn btn-sm btn-icon btn-transparent-dark dropdown-toggle"
                        ...
                        aria-haspopup="true"
                        aria-expanded="false"
                        ><i class="fad fa-bell-on"></i></a>
                    <div
                        class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up"
                        aria-labelledby="navbarDropdownAlerts"
                    >
                        <h6
                            class="dropdown-header dropdown-notifications-header"
                        >
                            <i class="fad fa-bell mr-2"></i>Alerts
                            Center
                        </h6>
                        <a
                            ...
                            <div class="dropdown-notifications-item-content">
                                ...
                                >
                                    This is an alert message. It&apos;s nothing
                        ...
                        ><a
                            ...
                            href="javascript:void(0);"
                            ><div
                                class="dropdown-notifications-item-icon bg-info"
                            >
                        ...
                        ><a
                            ...
                            href="javascript:void(0);"
                            ><div
                                class="dropdown-notifications-item-icon bg-danger"
                            >
                            ...
                            <div class="dropdown-notifications-item-content">
                                ...
                                <div
                                    class="dropdown-notifications-item-content-text"
                                >
                                    Critical system failure, systems shutting
                                    down.
                                </div>
                            </div></a
                        ><a
                            ...
                            <div class="dropdown-notifications-item-content">
                                ...
                                <div
                                    class="dropdown-notifications-item-content-text"
                                >
                                    New user request. Woody has requested access
                                    to the organization.
                                </div>
                            </div></a
                        ><a
                ...
                >
                    <a
                        ...
                        aria-haspopup="true"
                        aria-expanded="false"
                        ><i class="fad fa-envelope-open"></i></a>
                    <div
                        class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up"
                    ...
                    >
                        <h6
                            class="dropdown-header dropdown-notifications-header"
                        >
                            <i class="fad fa-envelope-open mr-2"></i>Message
                            Center
                        </h6>
                        <a
                            class="dropdown-item dropdown-notifications-item"
                            ...
                            >
                                ...
                                >
                                    ...
                                    ><a
                                        ...
                                        href="javascript:void(0);"
                                        data-toggle="collapse"
                                        data-target="#collapseLayoutsPageHeaders"
                                        aria-expanded="false"
                            ...
                            >
                                <nav class="sidenav-menu-nested nav">
                                    <a class="nav-link" href="alerts.html"
                                        >Alerts</a
                                    ><a class="nav-link" href="avatars.html"
                                        >Avatars<span
                                            class="badge badge-primary ml-2"
                                            >New!</span
                                        ></a
                                    ...
                                    ><a class="nav-link" href="cards.html"
                                        >Cards</a
                                    ><a class="nav-link" href="dropdowns.html"
                                        >Dropdowns</a
                                    ...
                                    ><a class="nav-link" href="progress.html"
                                        >Progress</a
                                    ><a class="nav-link" href="toasts.html"
                                        >Toasts</a
                                    ><a class="nav-link" href="tooltips.html"
                                        >Tooltips</a
                                    >
                                </nav>
                            </div>
                                ...
                                <nav class="sidenav-menu-nested nav">
                                    ...
                                    ><a class="nav-link" href="background.html"
                                        >Background<span
                                            ...
                                            >New!</span
                                        ></a
                                    ><a class="nav-link" href="borders.html"
                                        >Borders</a
                                    ><a class="nav-link" href="lift.html"
                                        >Lift<span
                                            ...
                                            >New!</span
                                        ></a
                                    ><a class="nav-link" href="shadows.html"
                                        >Shadows</a
                                ...
                                >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <a
                                                        class="nav-link"
                                                        href="login-social.html"
                                                        >Login</a
                                                    ><a
                                                        class="nav-link"
                                                        href="register-social.html"
                                                        >Register</a
                                                    ><a
                                                        class="nav-link"
                                                        href="password-social.html"
                                                        >Forgot Password</a
                                                    >
                                                </nav>
                                            </div>
                                    ...
                                    >
                                        <nav class="sidenav-menu-nested nav">
                                            ...
                                            ><a
                                                class="nav-link"
                                                href="404-glitch.html"
                                                >404 Page (Glitch Effect)</a
                ...
                <main>
                    ...
                    >
                        <div class="container-fluid">
                            <div class="page-header-content">
                                ...
                                <div
                                    class="page-header-subtitle fs-md-19 fs-14"
                                >
                                    A blank page to get you started!
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid mt-n10">
                        <div class="card">
                            ...
                            <div class="card-body">
                                This is a blank page. You can use this page as a
                                boilerplate for creating new pages!
                            </div>
                        </div>
                    </div>
                </main>
