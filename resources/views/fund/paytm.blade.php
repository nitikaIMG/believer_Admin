    ...
    <div class="col-md-12">
      <div class="card mb-3">
        <div class="card-heading p-3">
          <form method="get" action="<?php echo action('FundController@paytm')?>">
                  <?php
                        ...
                        <div class="row mx-0">
                            ...
                            <div class="col-12 text-right mt-4 mb-2">
                              <button class="btn btn-sm btn-success text-uppercase"><i class="far fa-check-circle"></i>&nbsp;Submit</button>
                               <a href="<?php echo action('FundController@paytm')?>" class="btn btn-sm btn-warning text-uppercase"><i class="far fa-undo"></i>&nbsp;Reset</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="card mb-4">
    <div class="card-header">Paytm Report</div>
    <div class="card-body">
        ...
        <div class="datatable table-responsive">
            <table class="table table-bordered table-striped table-hover text-nowrap" id="paytmtable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>S No.</th>
                        <th>User Id</th>
...
<script type="text/javascript">
    ...
    $.fn.dataTable.ext.errMode = 'none';
        $('#paytmtable').DataTable({
            'bFilter':false,
        "processing": true,
            "serverSide": true,
            "ajax":{
                     "url": '<?php echo URL::asset('my-admin/paytmtable');?>?startdate='+startdate+'&playername='+playername+'&enddate='+enddate+'&mobile='+mobile,
                     "dataType": "json",
                     "type": "POST",
