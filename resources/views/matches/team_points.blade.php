    ...
    <div class="col-md-12">
      <div class="card mb-3">
        <div class="card-heading p-3">
          <form action="{{asset('my-admin/team_points/'.$findmatchdetails->matchkey)}}">
                    ...
                    <div class="form-group">
                        <div class="row mx-0 align-items-end">
                            ...
                            <div class="col-md-auto text-right mb-md-3">
                              ...
                              <button type="reset" value="Reset" class="btn btn-sm btn-warning text-uppercase" onclick="window.location.href='{{asset('my-admin/team_points/'.$findmatchdetails->matchkey)}}'"><i class="far fa-undo" ></i>&nbsp; Reset</buttom>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row mx-0">
      <div class="col-lg-12">
            <ul class="row text-center bg-white shadow rounded overflow-hidden match_points_tabses list-unstyled">
                ...
                <li class="col-md p-0"><a class="py-3 text-decoration-none font-weight-bold text-uppercase border-left w-100 d-block active" href="{{ asset('my-admin/team_points/'.$findmatchdetails->matchkey)}}">TEAM</a></li>
          </ul>
           ...
           <div class="card mb-4">
               <div class="card-header">
                <div class="row w-100 align-items-center mx-0">
                    <div class="col-md col-12 mb-md-0 mb-2 text-md-left text-center">Team Points</div>
             ...
             <tbody>
                ...
                <?php foreach($match_scores as $val1){ ?>
                    <tr>
                            ...
                            <td>
                                <?php if($val1->starting11==1){ echo 'True'; }else{ echo 'No'; } ?>
                            </td>
                            <td>
                            ...
                            <!-- <td>
                               ...
                               <a class="btn btn-success btn-sm text-uppercase" href="<?php  echo URL::asset('my-admin/player_points/'.$val1->matchplayers_matchkey.'/'.$val1->matchplayers_playerid) ?>"><i class="far fa-check-circle"></i>&nbsp; Update</a>
                            </td> -->
                    </tr>
                <?php } ?>
                <?php } ?>
