    ...
    <div class="col-md-12">
      <div class="card mb-3">
        <div class="card-heading p-3">
          <form method="get" action="<?php echo action('TeamController@view_team')?>">
                  <?php
                  $name="";$fantasy_type="";
                  if(isset($_GET['name'])){
                    $name = $_GET['name'];
                        ...
                        <div class="row mx-0 align-items-center">
                            ...
                            <div class="col-md-auto col-12 mt-md-4 pt-md-1 text-right">
                              <button class="btn btn-sm btn-success text-uppercase"><i class="far fa-check-circle"></i>&nbsp;Submit</button>
                                <a href="{{action('TeamController@view_team')}}" class="btn btn-sm btn-warning text-uppercase"><i class="far fa-undo" ></i>&nbsp; Reset</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row w-100 align-items-center mx-0">
            ...
            <div class="col-md-auto col-12 px-md-3 px-0 text-center">
                <input type="hidden" id="fantasy_type"  value="<?php echo $fantasy_type;?>">
                  <form action="<?php echo action('TeamController@downloadteamdata');?>" method="get">
...
<script type="text/javascript">
    ...
    $.fn.dataTable.ext.errMode = 'none';
        ...
        "processing": true,
            "serverSide": true,
            "ajax":{
                     "url": '<?php echo URL::asset('my-admin/view_team_datatable');?>?name='+name+'&fantasy_type='+fantasy_type,
                     "dataType": "json",
                     "type": "POST",
