    ...
    <div class="col-md-12">
      <div class="card mb-3">
        <div class="card-heading p-3">
          <form method="get" action="<?php echo action('VerificationController@paytm_withdraw_amount')?>">
         <?php
    ...
    @include('alert_msg')
        ...
        <div class="datatable table-responsive">
            ...
            <tr>
              <th>S.No.</th>
              <th>User Id</th>
              <th data-toggle="tooltip" title="Paytm Number">Paytm Number</th>
    ...
    $.fn.dataTable.ext.errMode = 'none';
        ...
        "processing": true,
            "serverSide": true,
             'responsive': true,
            "ajax":{
                     "url": '<?php echo asset('my-admin/paytm_withdrawl_amount_table');?>?status='+status+'&start_date='+start_date+'&email='+email+'&mobile='+mobile+'&end_date='+end_date,
                     "dataType": "json",
                     "type": "POST",
