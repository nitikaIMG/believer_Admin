    ...
    <div class="col-md-12">
      <div class="card mb-3">
        <div class="card-heading p-3">
          <form method="get" action="<?php echo action('YoutuberController@view_youtuber')?>">
                  <?php
                  $name="";$email="";$mobile="";
                  if(isset($_GET['name'])){
                    $name = $_GET['name'];
                    ...
                    <div class="form-group">
                        <div class="row mx-0">
                            ...
                            <div class="col-12 text-right mt-4 mb-2">
                                ...
                                <a href="<?php echo action('YoutuberController@view_youtuber')?>" class="btn btn-sm btn-warning text-uppercase"><i class="far fa-undo" ></i>&nbsp; Reset</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <table class="table table-bordered table-striped table-hover text-nowrap" id="allmatches_datatable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                      ...
                      <th class="text-capitalize">percentage</th>
      ...
      $(document).ready(function() {
        ...
        var mobile = $('#mobile').val();
            ...
            'bFilter':false,
                ...
                "searching": false,
                "ajax":{
                         "url": '<?php echo URL::asset('my-admin/view_youtuber_dt');?>?name='+name+'&email='+email+'&mobile='+mobile,
                         "dataType": "json",
                         "type": "POST",
